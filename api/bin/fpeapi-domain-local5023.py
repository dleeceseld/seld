...
# load into second list, rejoin with dot delims and return ecrypted string.# Modify this version of the rest service to accept a hostname, fqdn or domain as well as @ delimited and $ terminated strings
...
def update_data():
    ...
    if 'decnum' in request.args:
        ...
        print(dataresult)
    # Encrypt am aphanumeric string with "." delimiters
...
app.run(port=5023,host='127.0.0.1')